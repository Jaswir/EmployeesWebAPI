...
namespace EmployeesWebAPI.Data
{
    public class Seeder
    {
        public void Seed_Employees(ApplicationDbContext context)
        {
            ...
            var testEmployee = context.Employees.FirstOrDefault(b => b.FirstName == "Bill");
        ...
        private void AddEmployee(ApplicationDbContext context, string firstName, string lastName, string email, string department, long salary, DateTime dateOfBirth)
        {
